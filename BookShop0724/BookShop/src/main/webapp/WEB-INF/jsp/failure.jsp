				...
				<div class="col-md-8">
					<div class="row">
						...
						<div class="col-md-4">
							...
							<address>
								<strong>${sessionScope.user_session.identity } ${sessionScope.user_session.username }</strong><br> 欢迎您的光临！<br> 您是今天在线的<c:out value="${applicationScope.number }"></c:out>位顾客之一
							</address>
						</div>
					</div>
				</div>
