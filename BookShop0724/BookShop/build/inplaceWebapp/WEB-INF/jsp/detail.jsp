				...
				<div class="col-md-8">
					<div class="row">
						...
						<div class="col-md-4">
							...
							<address>
								 <strong>${sessionScope.user_session.identity } ${sessionScope.user_session.username }</strong><br> 欢迎您的光临！<br> 今天在线的顾客有<c:out value="${applicationScope.number }"></c:out>位
							</address>
						</div>
					</div>
				</div>
		...
		<div class="col-md-9">
			<div class="row">
				...
				<div class="col-md-9">
					...
					<blockquote>
						<p>
							<font size=5 face="方正舒体"><strong>欢迎来我的书店<font color="red">${book.bookname }</font>》</strong></font>
